...
$b      = get_body();
$norek  = trim(isset($b['norek'])  ? $b['norek']  : '');
$jumlah = (float)(isset($b['amount']) ? $b['amount'] : (isset($b['jumlah']) ? $b['jumlah'] : 0));
$ket    = trim(isset($b['remark']) ? $b['remark'] : (isset($b['keterangan']) ? $b['keterangan'] : 'Setor tunai'));
$user   = trim(isset($b['userid']) ? $b['userid'] : 'teller');
...
try {
    ...
    DB::begin();
    $transNo   = insert_folio($norek, 0, $jumlah, $ket ? $ket : 'Setor tunai', 'ST', $user);
